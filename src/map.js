const Map = {
    ...
    create() {
        ...
        this.locName = name == 'undefined' || name == null ? '森之岛1': name
        ...
        game.time.events.add(500, () => {
            ...
            util.showLocationIndicator.call(this, this.locName)
        })
    ...
    nextLevelHandler (sprite, levelBody) {
        ...
        localStorage.setItem('locName', this.locName)
