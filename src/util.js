const util = {
    ...
    initButton (cb) {
        ...
        // this.spacekey.onDown.add(this.onAction? this.onAction.bind(this, cb): util.onAction.bind(this, cb))
    ...
    disableGamePadInput () {
        ...
        // this.spacekey.events.onDown.removeAll()
    },
    enableGamePadInput (cb) {
        ...
        // this.spacekey.onDown = (this.onAction? this.onAction.bind(this, cb): util.onAction.bind(this, cb), this)
    },
    ...
    nextLine() {
        ...
        if ((this.lineIndex && this.lineIndex % game.global.MAX_LINE == 0) || this.lineIndex == this.lines.length) {
            ...
            game.time.events.repeat(game.global.WORD_DELAY, line.length,  (line) => {
                util.nextWord.call(this, line)
            }, this, line);
            this.lineIndex++
        }
    },
    nextWord(line) {
        ...
        if (this.wordIndex === line.length) {
            ...
            game.time.events.add(game.global.LINE_DELAY, util.nextLine, this);
        }
    },
